...
def main(args=sys.argv):
    parser = argparse.ArgumentParser(
        description="Imap is a tool to display hdmap info on a map.", prog="main.py"
    )
    ...
    parser.add_argument(
        ...
        required=False,
        default=False,
        help="Whether to save the visualization figure (only for .xodr suffix)",
    )
    parser.add_argument(
        "-z",
        "--enable_z_axis",
        ...
        required=False,
        default=False,
        help="Whether to extract z-axis coordination information to apollo hd-map",
    )
    parser.add_argument(
        "-l",
        "--lane",
    ...
    parser.add_argument(
        "-i", "--input", action="store", type=str, required=False, help="map input path"
    )
    parser.add_argument(
        "-o",
        "--output",
