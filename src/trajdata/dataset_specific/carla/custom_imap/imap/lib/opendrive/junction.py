...
class Connection:
    def __init__(
        ...
        self.lane_links: List[Link] = []

        # private
        self.incoming_road_obj: Optional[Road] = None
        self.connecting_road_obj: Optional[Road] = None
...
class Junction:
    ...
    def is_incoming_road(self, incoming_road, connecting_road):
        for connection in self.connections:
            if (
                connection.incoming_road == incoming_road
                and connection.connecting_road == connecting_road
            ):
                return True
        return False
