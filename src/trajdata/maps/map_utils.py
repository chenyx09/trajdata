...
def interpolate(
    ...
    Args:
        ...
        num_pts (int, optional): How many points to interpolate to.
            Only one of num_pts or max_distance can be specified.
        max_distance (float, optional): Target distance between interpolated points. 
            Only one of num_pts or max_distance can be specified.
    ...
    if ((num_pts is None and max_distance is None) or 
            (num_pts is not None and max_distance is not None)):
        raise ValueError("Either one of num_pts or max_distance must be specified")
