...
def get_env_metadata(data_dirs: Dict[str, str]) -> Dict[str, EnvMetadata]:
    ...
    if 'nusc' in data_dirs:
        ...
        nusc_scene_split_map: Dict[str, str] = {v_elem: k for k, v in nusc_scene_splits.items() for v_elem in v}
    ...
    if 'nusc_mini' in data_dirs:
        ...
        # Inverting the dict from above, associating every scene with its data split.
        nusc_mini_scene_split_map: Dict[str, str] = {v_elem: k for k, v in nusc_mini_scene_splits.items() for v_elem in v}
